public class ValidatorMaxHeap<E extends Comparable<E>> implements IBTValidator<E> {
    ...
    public boolean validAdd(IBinTree<E> oldTree, E elt, IBinTree<E> newTree) {
        ...
        boolean bstInv = maxheapInvariant(newTree);
    ...
    public boolean maxheapInvariant(IBinTree<E> someTree){
        if(someTree.isEmpty()) { return true; }
        else {
            E root = someTree.getRoot();;
            IBinTree<E> left = someTree.getLeft();
            ...
            return biggerThanAll(root, left) &&
                    biggerThanAll(root, right) &&
                    maxheapInvariant(left) &&
                    maxheapInvariant(right);
        }
    }
